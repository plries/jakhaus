...
export const StatusModal = ({
  ...
  return (
    <div
      className={`fixed top-0 left-0 z-50 grid h-full w-full place-items-center bg-neutral-950/75 backdrop-blur-lg transition-opacity duration-300 ease-in-out ${(showModal && success) || (showModal && !success) ? "" : "pointer-events-none opacity-0"}`}
    >
