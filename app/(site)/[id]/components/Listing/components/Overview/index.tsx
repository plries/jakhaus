...
export const Overview = ({ CONSTANTS, FULL_ADDRESS }: SectionPropTypes) => {
  return (
    <IconContext.Provider value={{ weight: "light", size: 32 }}>
      <section className="overflow-hidden rounded-4xl shadow-xl">
        ...
        <div className="relative grid grid-cols-4 gap-5 bg-gradient-to-b from-neutral-800 to-neutral-950 p-5 md:grid-cols-8 md:p-10 lg:grid-cols-12 lg:gap-10">
          <Image
