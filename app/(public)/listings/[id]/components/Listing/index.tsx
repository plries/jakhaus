...
export const Listing = ({ CONSTANTS, FULL_ADDRESS }: SectionPropTypes) => {
  return (
    <IconContext.Provider value={{ size: 24, weight: "light" }}>
      <Navbar CONSTANTS={CONSTANTS} LINKS={NAVBAR_LISTING_CONST.LINKS} />
      ...
      <div className="grid grid-cols-4 gap-5 md:grid-cols-8 lg:grid-cols-12">
        <div className="col-span-full mx-2.5 grid grid-cols-4 gap-5 border-x border-x-neutral-300 py-5 md:grid-cols-8 lg:col-span-10 lg:col-start-2 lg:grid-cols-10 lg:py-10">
